...
# 44: fixed-cost M4 + legacy-L2 M4 (what #43 actually ran) + the hybrids.
...
LL_TOL = 0.02  # nats/draw, pre-specified log-lik tolerance (Q1, #44)
JUMP_THRESH = 0.15
...
def hybrid_verdict(conds_with_prox: list[tuple[dict, np.ndarray]],
    ...
    """#44 Q1 rule at the headline condition, pooled over questions.
